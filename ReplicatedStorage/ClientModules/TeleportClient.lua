...
local unlockSpawnRemote = ReplicatedStorage:WaitForChild("UnlockSpawnLocation")
...
function TeleportClient.getAvailableZoneSpawns()
        local spawnInfos = SpawnRegistry.getSpawnInfos()
        local results = {}
...
function TeleportClient.requestSpawnUnlock(spawnKey)
        ...
        unlockSpawnRemote:FireServer(spawnKey)
end
                ...
                if button then
                        button.Activated:Connect(function()
                                if not button.Active then
                                        notify("This teleport location is locked")
                                        return
                                end
